...
Habit _habitDeserialize(
  ...
  object.habitName = reader.readStringOrNull(offsets[1]);
  object.id = id;
  return object;
}
...
extension HabitQueryFilter on QueryBuilder<Habit, Habit, QFilterCondition> {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> habitNameIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> habitNameIsNotNull() {
    return QueryBuilder.apply(this, (query) {
